...
extern Cash CashFromValue(const json_spirit::Value& value);
extern json_spirit::Value ValueFromAmount(int64 amount);
extern json_spirit::Value ValueFromCash(Cash amount);
extern json_spirit::Value ValueFromFees(Fees fee);
extern json_spirit::Value ValueFromInt64(int64 input);
